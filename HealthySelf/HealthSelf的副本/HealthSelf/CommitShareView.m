...
// share
@property (nonatomic, strong) NSArray *userImgaeArray;
@property (nonatomic, strong) NSArray *userIdArray;
@property (nonatomic, strong) NSArray *userTitleArray;
@property (nonatomic, strong) NSArray *userCommentArray;
@property (nonatomic, strong) NSArray *userTxtImageArray;
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        CommentTableViewCell *cmtCell = [self.tableView dequeueReusableCellWithIdentifier:@"comment" forIndexPath:indexPath];
        cmtCell.userIdLabel.text = self.userIdArray[indexPath.row];
        cmtCell.commentLabel.text = self.userCommentArray[indexPath.row];
        cmtCell.userTitleLabel.text = self.userTitleArray[indexPath.row];
        cmtCell.userImgView.image = [UIImage imageNamed:self.userImgaeArray[indexPath.row]];
        cmtCell.textImgView.image = [UIImage imageNamed:self.userTxtImageArray[indexPath.row]];
        [cmtCell.moreMenuButton addTarget:self action:@selector(PressButton:) forControlEvents:UIControlEventTouchUpInside];
        cmtCell.tag = 2;
        return cmtCell;
    }
    return  0;
